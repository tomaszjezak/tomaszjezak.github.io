...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Research projects and side ventures.",
          section: "Navigation",
          handler: () => {
